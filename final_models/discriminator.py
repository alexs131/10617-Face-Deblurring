...
class Discriminator(nn.Module):
    def __init__(self, input_channels, num_filters_init):
        super(Discriminator, self).__init__()
        self.network = nn.Sequential(
            nn.Conv2d(input_channels, num_filters_init, 4, 2, 1),
...
# Citation: https://pytorch.org/tutorials/beginner/dcgan_faces_tutorial.html
def weights_init(m):
